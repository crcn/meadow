...
export function TopicRootNode({ data }: TopicRootNodeProps) {
  return (
    <div className="px-5 py-4 rounded-xl bg-gradient-to-br from-meadow-accent to-meadow-root text-white text-center min-w-[160px] max-w-[260px] shadow-[0_2px_8px_rgba(0,0,0,0.06),0_0_0_1px_rgba(0,0,0,0.03)]">
